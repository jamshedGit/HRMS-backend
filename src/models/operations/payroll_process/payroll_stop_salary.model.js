...
const Payroll_Stop_SalaryModel = sequelize.define('t_payroll_stop_salary', {
    Id: {
  ...
  Payroll_Stop_SalaryModel.belongsTo(SubsidiaryModel, {
    foreignKey: 'subsidiaryId',
    targetKey: 'Id',
    as: "Subsidiary"
});

Payroll_Stop_SalaryModel.belongsTo(FormModel, {
...
Payroll_Stop_SalaryModel.belongsTo(PayrollMonthModel, {
    foreignKey: 'payroll_monthId',
    targetKey: 'Id',
    as: "PayrollMonth"
});

module.exports = Payroll_Stop_SalaryModel;