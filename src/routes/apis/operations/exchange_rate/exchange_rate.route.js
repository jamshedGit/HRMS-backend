...
router.route("/read-exchange-rate").post(auth(),  exchange_rateController.getExchangeRateById);
...
router.route("/read-last-exchange-rate").post(auth(),  exchange_rateController.getLastExchangeRateBySubsidiary);
