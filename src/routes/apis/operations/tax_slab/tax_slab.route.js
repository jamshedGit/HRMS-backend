...
router.route("/read-all-tax-slab").post(auth(),  tax_slabController.getAlltax_slabs);
// router.route("/create-tax_slab").post(auth(), tax_slabController.createtax_slab);
router.route("/update-tax-slab").put(auth(),  tax_slabController.updatetax_slab);
router.route("/delete-tax-slab").patch(auth(),tax_slabController.deletetax_slab);
